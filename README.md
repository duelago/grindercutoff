...
**Automatic grind-by-weight for "dumb" espresso grinders using a MyScale KP2048B scale, an ESP32-C6, and a Tasmota wifi smart plug. Tasmota can be controlled locally via http or with MQTT.**
...
<img width="611" height="857" alt="web" src="https://github.com/user-attachments/assets/6ac29a05-15fc-4945-be77-f95030a479ab" />
...
1. Place the portafilter on the scale and tare it. (LED on esp32 turns blue if scale is connected and the buzzer will buzz)
...
| Buzzer (connect to pin 7 and GND)| https://www.aliexpress.com/w/wholesale-passive-buzzer-3.3v.html |
